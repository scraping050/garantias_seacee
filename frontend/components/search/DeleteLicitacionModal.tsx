...
export default function DeleteLicitacionModal({ isOpen, onClose, licitacion, onConfirm }: DeleteLicitacionModalProps) {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[99999] overflow-y-auto">
            ...
            {/* Modal Container - Ensures centering with scrolling */}
            <div className="flex min-h-full items-center justify-center p-4">

                <div className="bg-white dark:bg-[#111c44] rounded-2xl w-full max-w-md shadow-2xl border border-slate-300 dark:border-slate-600 overflow-hidden relative z-10">
